...
Die Ergebnisse sind hier deutlich näher an den korrekten Werten, aber immernoch nicht ganz korrekt.
...
```{r}
surv_km <- adjustedsurv(data=d_match,
                        variable="interact",
                        ev_time="event_time",
                        event="status",
                        method="km")
